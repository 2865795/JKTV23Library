...
public class JavaConfiguration implements Configuration {
    ...
    private void init() {
        ...
        map.put("authorService", new AuthorService((Input) map.get("input"), (AppHelper<Author>) map.get("appHelperAuthor"), (Repository<Author>) map.get("repositoryAuthor")));
        ...
        map.put("app", new App((Input) map.get("input"), (Service<Book>) map.get("bookService"), (Service<Author>) map.get("authorService"), (Service<User>) map.get("userService"), (Service<Register>) map.get("registerService")));
        this.map = map;
    }
